(ns marketentry.store
  "SSoT for the ROU market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems RO" :portal "SEAP/SICAP"
             ...
             :requires-cui? true :cui-verified? true
             :drafted? false :submitted? false
             :jurisdiction "ROU" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "SEAP/SICAP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-cui? true :cui-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "SEAP/SICAP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "ROU" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "SEAP/SICAP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "ROU" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "SEAP/SICAP"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-cui? true :cui-verified? false
             :drafted? false :submitted? false
             :jurisdiction "ROU" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "SEAP/SICAP"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-cui?)    (assoc :engagement/requires-cui? requires-cui?)
    (some? cui-verified?)    (assoc :engagement/cui-verified? cui-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-cui? :engagement/cui-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-cui? (boolean (:engagement/requires-cui? m))
     :cui-verified? (boolean (:engagement/cui-verified? m))
